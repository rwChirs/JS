...
// 查询所有
/*
exports.findAll = (pageSize, page, cb) => {
    // sql 语句    
    // let query = 'select * from posts';    
    let query = 'select * from posts left join users on posts.uid = users.id;';
    // 执行 sql 语句
...
exports.modify = (id, data, cb) => {
    ...
    // 上面第三个参数是回调函数，下面cb也是回调函数，直接给即可，没必要写逻辑了，node特点：第一个参数就是错误参数，如果有就是错误信息，没有就是null
